 ...
 */
#ifndef __TWOFISH_TWOFISH
#define __TWOFISH_TWOFISH
...
void Twofish_encrypt_ctr(Twofish_key *xkey, Twofish_Byte iv[16], Twofish_Byte *buff, size_t buff_len, Twofish_Byte *c);
